...
file_path = os.path.join(current_directory, 'downloads/ml-latest-small/movies.csv')
file_path_ratings = os.path.join(current_directory, 'downloads/ml-latest-small/ratings.csv')
