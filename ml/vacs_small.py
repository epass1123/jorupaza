...
file_path_ratings = os.path.join(current_directory, 'ml-small/mean_centered_ratings_small.csv')
...
def main() :
    ...
    with open(file_path_ratings, 'r') as f:
        for idx, line in enumerate(f):
            ...
            fappendline('ml-small/history.txt', f'{current_step},{dt}\n')
            ...
            if current_step % 25 == 0 :
                for c in CRITS : #c : movieID
                    ...
                    fappendline('ml-small/result.txt', "result:"+','.join(map(str,result))+','+dt+'\n')
                    fappendline('ml-small/result.txt', "result_sims:"+','.join(map(str,result_sims))+','+dt+'\n')
            
            #############################################################SAVE############################################################
            if current_step % 100 == 0 :
                #process at savepoint
                #save
                with open(f'ml-small/encoded_{current_step}_small.pickle', 'wb') as w:
